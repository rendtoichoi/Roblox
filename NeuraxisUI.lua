...
function Neuraxis:CreateNeuraxis(neuraxisName)
    neuraxisName = neuraxisName or "Neuraxis"
    ...
    tabFrame.BorderColor3 = Color3.fromRGB(35, 35, 35)
    ...
    closeLib.ImageColor3 = Color3.fromRGB(200, 200, 200)
    closeLib.MouseButton1Click:Connect(function()
        ...
        if isClosed then
            ...
            game.TweenService:Create(MainWhiteFrame_2,
                TweenInfo.new(0.10, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
                    BackgroundTransparency = 1
                }):Play()
            game.TweenService:Create(MainWhiteFrame,
                TweenInfo.new(0.10, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
                    BackgroundTransparency = 1
                }):Play()
        else
    ...
    elementContainer.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
    ...
    function SectionHandler:CreateSection(secName)
        ...
        mainCorner_3.CornerRadius = UDim.new(0, 6)
        ...
        newPage.ScrollBarImageColor3 = Color3.fromRGB(70, 70, 70)
        ...
        function ElementHandler:TextLabel(labelText)
            ...
            labelFrame.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
        ...
        function ElementHandler:TextButton(buttonText, buttonInfo, callback)
            ...
            textButtonFrame.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
            ...
            TextButton.TextColor3 = Color3.fromRGB(10, 10, 10)
            ...
            textButtonInfo.TextColor3 = Color3.fromRGB(160, 160, 160)
        ...
        function ElementHandler:Toggle(togInfo, callback)
            ...
            toggleInfo.TextColor3 = Color3.fromRGB(160, 160, 160)
            ...
            toggleInerFrame.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
            ...
            toggleInnerFrame1.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
            ...
            toggleBtn.MouseButton1Click:Connect(function()
                ...
                callback(toggled)
                if toggled then
                    game.TweenService:Create(toggleBtn,
        ...
        function ElementHandler:Slider(sliderin, minvalue, maxvalue, callback)
            ...
            sliderInfo.TextColor3 = Color3.fromRGB(160, 160, 160)
            ...
            sliderBtn.BackgroundColor3 = Color3.fromRGB(38, 38, 38)
            ...
            sliderMainFrm.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            sliderMainFrm.BorderColor3 = Color3.fromRGB(255, 255, 255)
            ...
            sliderBtn.MouseButton1Down:Connect(function()
                Value = math.floor((((tonumber(maxvalue) - tonumber(minvalue)) / 141) * sliderMainFrm.AbsoluteSize.X) +
                ...
                moveconnection = mouse.Move:Connect(function()
                    ...
                    Value = math.floor(
                        (((tonumber(maxvalue) - tonumber(minvalue)) / 141) * sliderMainFrm.AbsoluteSize.X) +
                            tonumber(minvalue))
                    pcall(function()
                        callback(Value)
                    end)
                    sliderMainFrm.Size = UDim2.new(0, math.clamp(mouse.X - sliderMainFrm.AbsolutePosition.X, 0, 141), 0,
                        10)
                end)
                releaseconnection = uis.InputEnded:Connect(function(Mouse)
                    if Mouse.UserInputType == Enum.UserInputType.MouseButton1 then
                        Value = math.floor((((tonumber(maxvalue) - tonumber(minvalue)) / 141) *
                                               sliderMainFrm.AbsoluteSize.X) + tonumber(minvalue))
                        pcall(function()
                            callback(Value)
                        end)
                        sliderValue.Text = Value .. "/" .. maxvalue
                        sliderMainFrm.Size = UDim2.new(0,
                            math.clamp(mouse.X - sliderMainFrm.AbsolutePosition.X, 0, 141), 0, 10)
        ...
        function ElementHandler:KeyBind(keInfo, firstt, callback)
            ...
            keybindinfo.TextColor3 = Color3.fromRGB(160, 160, 160)
        ...
        function ElementHandler:TextBox(textInfo, placeHolderText1, callback)
            ...
            textboxInfo.TextColor3 = Color3.fromRGB(160, 160, 160)
            ...
            texboxInner.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
            ...
            textboxinneer.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
        ...
        function ElementHandler:Dropdown(dInfo, list, callback)
            ...
            dropdownmain.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
